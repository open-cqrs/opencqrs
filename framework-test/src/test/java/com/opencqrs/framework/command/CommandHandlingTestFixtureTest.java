...
public class CommandHandlingTestFixtureTest {
    ...
    public class Setup {
        ...
        public void stateRebuildingHandlersCalledFilteredByInstanceClassBeforeCommandExecution() {
            ...
            CommandHandlingTestFixture.withStateRebuildingHandlerDefinitions(eshds)
                    ...
                    .given()
                    .event((Consumer<EventSpecifierDsl>) e -> e.payload(new EventA("irrelevant")))
        ...
        public class UsingSubject {
            ...
            public void subjectAppliedToGivenEvents() {
                ...
                CommandHandlingTestFixture.withStateRebuildingHandlerDefinitions(
                        ...
                        .event((Consumer<EventSpecifierDsl>) e -> e.payload(new EventA("test")))
                        .usingSubject("/test-subject/b")
                        .event((Consumer<EventSpecifierDsl>)
                                e -> e.subject(null).payload(new EventB(42L)))
                        .when(new DummyCommand())
                        .succeeds()
                        .allEvents()
                        .count(0);
            ...
            public void subjectNotAppliedToGivenEventsIfExplicitlySpecified() {
                ...
                CommandHandlingTestFixture.withStateRebuildingHandlerDefinitions(new StateRebuildingHandlerDefinition(
                        ...
                        .event((Consumer<EventSpecifierDsl>)
                                e -> e.subject("/explicit-subject").payload(new EventA("test")))
                        .when(new DummyCommand())
                        .succeeds();
    ...
    public class Expect {
        ...
        @Nested
        @DisplayName("havingResult after event assertions")
        public class HavingResultAfterEventAssertions {

            @Test
            public void havingResultAfterAllEventsUsingAnd_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Long>) (c, publisher) -> {
            ...
            @Test
            public void havingResultAfterNextEventsTerminal_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Long>) (c, publisher) -> {
                                            publisher.publish(new EventA("one"));
        ...
        @Nested
        @DisplayName("fails().throwing(instance)")
        public class FailsThrowingInstance {

            @Test
            public void matchingTypeAndMessage_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
                                            throw new RuntimeException("test error");
                                ...
                                .when(new DummyCommand())
                                .fails()
                                .throwing(new RuntimeException("test error")))
                        .doesNotThrowAnyException();
            }
            ...
            public void wrongType_failing() {
                assertThatThrownBy(() -> subject.using(
                                ...
                                .when(new DummyCommand())
                                .fails()
                                .throwing(new IllegalStateException("test error")))
                        .isInstanceOf(AssertionError.class)
                        .hasMessageContainingAll("wrong type");
            }

            @Test
            public void wrongMessage_failing() {
                assertThatThrownBy(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
                                ...
                                .when(new DummyCommand())
                                .fails()
                                .throwing(new RuntimeException("expected error")))
                        .isInstanceOf(AssertionError.class)
                        .hasMessageContainingAll("wrong message");
            }

            @Test
            public void nullMessage_matching_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
        ...
        public class AllEventsOnce {
            ...
            public void emptyStream_failing() {
                assertThatThrownBy(() -> subject.using(
                                ...
                                .once(e -> e.ofType(EventA.class)))
                        .isInstanceOf(AssertionError.class)
                        .hasMessageContainingAll("exactly one", "no events were captured");
            }
        }
        ...
        public class AllEventsNone {
            ...
            @Test
            public void emptyStream_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class, (CommandHandler.ForCommand<DummyState, DummyCommand, Void>)
                                                (c, publisher) -> null)
                                .given()
        ...
        public class AllEventsExactly {
            ...
            public void allMatchInOrder_notFailing() {
                assertThatCode(() -> subject.using(
                                ...
                                .succeeds()
                                .allEvents()
                                .exactly(new EventA("one"), new EventB(2L)))
                        .doesNotThrowAnyException();
            }

            @Test
            public void notEnoughEvents_failing() {
                assertThatThrownBy(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
                                            publisher.publish(new EventA("one"));
                                ...
                                .exactly(new EventA("one"), new EventB(2L)))
                        .isInstanceOf(AssertionError.class)
                        .hasMessageContainingAll("exactly", "2", "captured", "1");
            }

            @Test
            public void tooManyEvents_failing() {
                assertThatThrownBy(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
                                            publisher.publish(new EventA("one"));
                                ...
                                .exactly(new EventA("one"), new EventB(2L)))
                        .isInstanceOf(AssertionError.class)
                        .hasMessageContainingAll("exactly", "2", "captured", "3");
            }
            ...
            public void wrongOrder_failing() {
                assertThatThrownBy(() -> subject.using(
                                ...
                                .succeeds()
                                .allEvents()
                                .exactly(new EventB(2L), new EventA("one")))
                        .isInstanceOf(AssertionError.class);
            }

            @Test
            public void singleEvent_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
                                            publisher.publish(new EventA("one"));
        ...
        @Nested
        @DisplayName("nextEvents().remaining")
        public class NextEventsRemaining {

            @Test
            public void exactCount_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
                                            publisher.publish(new EventA("one"));
            ...
            @Test
            public void exactCountAfterSkipping_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
                                            publisher.publish(new EventA("one"));
            ...
            @Test
            public void zeroRemaining_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class, (CommandHandler.ForCommand<DummyState, DummyCommand, Void>)
                                                (c, publisher) -> null)
                                .given()
        ...
        public class NextEventsSingle {
            ...
            @Test
            public void remainingLengthOneButValidationFails_failing() {
                assertThatThrownBy(() -> subject.using(
                                        DummyState.class,
                                        (CommandHandler.ForCommand<DummyState, DummyCommand, Void>) (c, publisher) -> {
                                            publisher.publish(new EventA("one"));
        ...
        public class NextEventsOnce {
            ...
            public void noRemaining_failing() {
                assertThatThrownBy(() -> subject.using(
                                ...
                                .once(e -> e.ofType(EventA.class)))
                        .isInstanceOf(AssertionError.class)
                        .hasMessageContainingAll("exactly one", "remaining", "no events remain");
            }
        }
        ...
        public class NextEventsExactly {
            ...
            public void matchAfterSkip_notFailing() {
                assertThatCode(() -> subject.using(
                                ...
                                .nextEvents()
                                .skipping(1)
                                .exactly(new EventB(2L), new EventC()))
                        .doesNotThrowAnyException();
            }
        ...
        public class NextEventsNone {
            ...
            @Test
            public void noRemaining_notFailing() {
                assertThatCode(() -> subject.using(
                                        DummyState.class, (CommandHandler.ForCommand<DummyState, DummyCommand, Void>)
                                                (c, publisher) -> null)
                                .given()
