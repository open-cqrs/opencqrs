...
public class CommandHandlingTestFixture<I, C extends Command, R> {
    ...
    public class Expect implements Initializing<I, R>, Common<I, R> {
        ...
        public class Succeeding implements ExpectDsl.Succeeding<I, R> {
            @Override
            public ExpectDsl.Succeeding<I, R> withoutEvents() {
        ...
        public class AllEvents implements All<I, R> {
            ...
            @Override
            public All<I, R> single(Consumer<EventValidator<I, R>> consumer, Consumer<EventValidator<I, R>>... consumers) {
        ...
        public class NextEvents implements Next<I, R> {
            ...
            @Override
            public Next<I, R> single(Consumer<EventValidator<I, R>> consumer, Consumer<EventValidator<I, R>>... consumers) {
                List<Consumer<EventValidator<I, R>>> allConsumers = new ArrayList<>();
                allConsumers.add(consumer);
                allConsumers.addAll(Arrays.asList(consumers));
        ...
        @Override
        public ExpectDsl.Succeeding<I, R> succeeds() {
            if(throwable != null) {
        ...
        public class EventValidatorImpl implements EventValidator<I, R> {
            ...
            @Override
            public EventValidator<I, R> asserting(Consumer<EventAsserting> asserting) {
