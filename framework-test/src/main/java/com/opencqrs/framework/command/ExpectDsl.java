...
public interface ExpectDsl {
    ...
    interface All {
         ...
         *
         * <p>To assert that exactly one event matches in a stream of any length, use {@link #once(Consumer)}. To
         * combine an event-count check with single-event validation:
         *
         * <pre>
        ...
        /**
         * Asserts that exactly one event in the captured list matches the validation. The stream must not be empty and
         * exactly one event must match — non-matching events are allowed.
         *
         * @param consumer a consumer that validates events via {@link EventValidator}
         * @return {@code this} for method chaining
         * @throws AssertionError if zero or more than one event matches, or the stream is empty
         */
    ...
    interface Next {
         ...
         *
         * <p>To assert that exactly one remaining event matches in a stream of any length, use {@link #once(Consumer)}.
         *
         * <p>Example:
         *
         * <pre>
