...
public interface ExpectDsl {
    ...
    interface All {
        ...
        All exactly(Consumer<EventValidator> consumer, Consumer<EventValidator>... consumers); // Ist exactly() auf All terminating für All? Danach kann ja nichts mehr kommen und es müsste alles abgefragt sein. Es sei denn, man will danach noch mit z.B. single() auf eine Sache validieren?
    ...
    interface Next {
         ...
         * konsumiert wären.
         */
        Next single(Consumer<EventValidator> consumer); // konsumiert zwar events, setzt den iterator dann aber wieder an den Ausgang zurück
        Next any(Consumer<EventValidator>  consumer, Consumer<EventValidator>... consumers); // Prüft Anzahl der übergebenen Events in beliebiger Reihenfolge
        Next exactly(Consumer<EventValidator>  consumer, Consumer<EventValidator>... consumers); // Püft Anzahl der übergebenen Events in exakter Reihenfolge
