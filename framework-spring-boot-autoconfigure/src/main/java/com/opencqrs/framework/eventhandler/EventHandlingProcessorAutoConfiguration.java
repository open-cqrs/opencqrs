            ...
            eventHandlerDefinitions.stream()
                    ...
                    .forEach((group, ehds) -> {
                        ...
                        for (int partition = 0;
                                ...
                                partition++) {
                            var processorBeanName = "openCqrsEventHaSmartInitializingSingletonndlingProcessor_" + group
                                    + "_" + partition;

                            var eventHandlingProcessorBeanDefinition = BeanDefinitionBuilder.genericBeanDefinition(
                            ...
                            beanRegistry.registerBeanDefinition(
                                    processorBeanName, eventHandlingProcessorBeanDefinition);
                            ...
                            log.info(() -> "registered event handling processor '" + processorBeanName + "' with: "
                                    + settings);
