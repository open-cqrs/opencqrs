...
| any                                                                         | `java.lang.InterruptedException` or {{ javadoc_class_ref("com.opencqrs.framework.client.ClientInterruptedException") }}                     | interruption of the event-processor (virtual) thread while shutting down the {{ javadoc_class_ref("com.opencqrs.framework.eventhandler.EventHandlingProcessor") }} | processing loop terminated |
...
| `life-cycle.controller-factory` | a custom {{ javadoc_class_ref("com.opencqrs.framework.eventhandler.EventHandlingProcessorLifecycleControllerFactory") }} bean reference overriding `life-cycle.controller` | n/a                                                                                                                                                                                                                                                                |
