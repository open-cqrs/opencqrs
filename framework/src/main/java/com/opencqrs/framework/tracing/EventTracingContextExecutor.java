...
/**
 * Interface for restoring W3C Trace Context from {@link Event} records
 *
 * @see <a href="https://www.w3.org/TR/trace-context/">official W3C "Trace Context" standard</a>
 */
public interface EventTracingContextExecutor {
     ...
     */
    void executeInRestoreContextFromEvent(Event event, Runnable runnable);
}
