...
public interface TracingContextSpanBuilder {
    ...
    /**
     * Shorthand for {@link TracingContextSpanBuilder#executeRunnableWithNewSpan(Map, Runnable, UnaryOperator)} when no post-processing is needed
     */
    ...
    /**
     * Shorthand for {@link TracingContextSpanBuilder#executeSupplierWithNewSpan(Map, Supplier, BiFunction)} when no post-processing is needed
     */
