...
public class NoTracingContextSpanBuilder implements TracingContextSpanBuilder {

    /**
     * see: {@link NoTracingContextSpanBuilder#executeRunnableWithNewSpan(Map, Runnable, UnaryOperator)}
     *
     * @param spanInfo
     * @param runnable
     */
    ...
    /**
     * see: {@link NoTracingContextSpanBuilder#executeSupplierWithNewSpan(Map, Supplier, BiFunction)}
     *
     */
    @Override
